...
final class JdbcConnectionStringPropertyConstants {
    ...
    static final String POSTGRES_PLUGIN_CLASS_NAME = "com.azure.jdbc.msi.extension.postgresql.AzurePostgresqlMSIAuthenticationPlugin";
    static final String MYSQL_PLUGIN_CLASS_NAME = "com.azure.jdbc.msi.extension.mysql.AzureMySqlMSIAuthenticationPlugin";
